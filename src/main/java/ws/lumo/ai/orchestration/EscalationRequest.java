 ...
 */
public record EscalationRequest(String adapterId, String originalQuery, Map<String, String> customerContactInfo, Map<String, String> originalMessageContext, String customerName) {
}
